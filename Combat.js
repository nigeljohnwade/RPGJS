function Combat(){
	...
	this.basicMeleeAttack = function(instigator){
	...
	this.basicRangedAttack = function(instigator){
	...
	this.inflictDamage = function(hits, damage){
	...
	this.receiveDamage = function(retaliator,damage){
